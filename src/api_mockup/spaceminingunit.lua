...
function SpaceMiningUnit()
    ...
    ---@return number state The status of the space mining unit can be (Stopped = 1, Running = 2, Jammed output full = 3, Jammed no output container = 4)
    ...
    ---@param status number The status of the space mining unit can be
