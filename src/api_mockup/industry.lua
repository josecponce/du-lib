...
function Industry.new()
    ...
    ---@return number value (Stopped = 1, Running = 2, Jammed missing ingredient = 3, Jammed output full = 4, Jammed no output container = 5, Pending = 6, Jammed missing schematics = 7)
    ...
    ---@return number success The result of the operation 0 for a sucess, -1 if the industry is running
    ...
    ---@param id number The product item id
    ...
    ---@param status number The status of the industry can be (Stopped = 1, Running = 2, Jammed missing ingredient = 3, Jammed output full = 4, Jammed no output container = 5, Pending = 6)
