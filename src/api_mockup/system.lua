...
function System.new()
    ...
    ---@param mode number The camera mode, represented by an integer (First Person View = 1, Look Around Construct View = 2, Follow Construct View = 3)
    ...
    ---@return number value 1 on success, 0 on failure.
    ...
    ---@return number value The current value of the screen height
    function self.getScreenHeight() end

    --- Return the current value of the screen width
    ---@return number value The current value of the screen width
    ...
    ---@return number mode 1: First Person View, 2: Look Around Construct View, 3: Follow Construct View
    function self.getCameraMode() end

    --- Checks if the active camera is in first person view.
    ---@return number value 1 if the camera is in first person view.
    ...
    ---@return number value 1 when locked and 0 when unlocked
    ...
    ---@return number value 1 if a sound is playing
