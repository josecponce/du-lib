...
---@field limit number This property represents the number of times events can invoke this action.
---@field nbCall number This property keeps track of how many times events have invoked this action.
