...
function Screen()
    ...
    ---@return number 1 if the screen is on
    ...
    ---@param id number An number ID that is used to identify the html element in the screen. Methods such as addContent return the ID that you can store to use later here
    ---@param html string The HTML content to display, which can contain SVG html elements to make drawings
    ...
    ---@return number 1 if the mouse is pressed, otherwise 0
