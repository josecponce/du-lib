...
function Player.new()
    ...
    ---@return number value The ID of the player
    ...
    ---@return number value 1 if the player is frozen, 0 otherwise
    function self.isFrozen() end

    --- Checks if the player has DRM autorization to the control unit
    ---@return number value 1 if the player has DRM autorization on the control unit
    function self.hasDRMAutorization() end

    --- Emitted when the player parent change
    ---@param oldId number The previous parent construct ID
    ---@param newId number The new parent construct ID
