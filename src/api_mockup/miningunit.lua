...
--- Extracts a regular amount of resources from the ground.
---@class MiningUnit : Element
MiningUnit = {}
MiningUnit.__index = MiningUnit

---@return MiningUnit
function MiningUnit.new()
    ---@type self
    local self = Element.new()

    --- Returns the current state of the mining unit
    ---@return number state The status of the mining unit can be (Stopped = 1, Running = 2, Jammed output full = 3, Jammed no output container = 4)
    ...
    ---@param oreId number The item ID of the ore extracted during the calibration process
    ...
    ---@param status number The status of the mining unit can be (Stopped = 1, Running = 2, Jammed output full = 3, Jammed no output container = 4)
