...
--- Stores key/value pairs in a persistent way.
---@class Databank : Element
Databank = {}
Databank.__index = Databank

---@return Databank
function Databank.new()
    ---@type self
    ...
    ---@return number value 1 if the key exists and 0 otherwise
    function self.hasKey(key) end

    --- Remove the given key if the key is present in the Databank
    ---@param key string The key used to store a value
    ---@return number value 1 if the key has been successfully removed, 0 otherwise
    ...
    --- Stores an number value at the given key
    ---@param key string The key used to store the value
    ---@param val number The value, as an number
    function self.setIntValue(key,val) end

    --- Returns value stored in the given key as an number
    ---@param key string The key used to retrieve the value
    ---@return number value The value as an number
