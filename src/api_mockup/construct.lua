...
function Construct.new()
    ...
    ---@return number entity The owner entity table with fields {[int] id, [bool] isOrganization} describing the owner. Use system.getPlayerName(id) and system.getOrganization(id) to retrieve info about it
    ...
    ---@return number value local id of the current active orientation unit (core unit or gyro unit)
    ...
    ---@param mode number The docking mode (Manual = 0, Automatic = 1, Semi-automatic = 2)
    ---@return number
    function self.setDockingMode(mode) end
    --- Returns the current docking mode
    ---@return number mode The docking mode (Manual = 0, Automatic = 1, Semi-automatic = 2)
    ...
    ---@param id number The id of the docking construct
