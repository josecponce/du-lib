...
function Weapon.new()
    ...
    ---@param ammoId number The item id of the ammo
    ...
    ---@param targetId number The construct id of the target
    ...
    ---@param targetId number The construct id of the target
    ---@param itemId number The item id of the destroyed element
    ...
    ---@return number state 1 if the weapon is operational, otherwise 0 = broken, -1 = incompatible size
    ...
    ---@return number status The current status of the weapon (Idle = 1, Firing = 2, Reloading = 3, Unloading = 4)
